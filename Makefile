# This Makefile is for the bookstore extension to perl.
#
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: bookstore' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "bookstore",' >> META_new.json
